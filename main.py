...
def getRandomFortune():
    ...
    "You have tamed the mighty Python, now free it onto the Great Spider's Web",
    "Everyone loves you",
    "Never forget, Chewbacca is a Wookie",
    "You belong in the resistance"
    ]
    index = random.randrange(0,len(fortunes))

    return "Your fortune: " + "<strong>" + fortunes[index] + "</strong>"
